 ...
 *
 */
public class TableScriptXML {
	private static final Logger log = Util.getLogger(TableScriptXML.class);
	private static final String TABLE_DETAILS_XML = "interface_table_script.xml";
	private TableStore tableStore;
	private Map<String, String> tableStoreMap;
	
	public TableScriptXML() {
		init();
	}
