...
SNO INTEGER NOT NULL GENERATED ALWAYS AS IDENTITY (START WITH 1, INCREMENT BY 1),
STUDENT_ID VARCHAR(8) NOT NULL REFERENCES STUDENTS_DETAILS(STUDENT_ID) ON DELETE CASCADE ,
GROUP_ID CHAR,
EVENT_ID VARCHAR(15),
COLLEGE_ID VARCHAR(8) NOT NULL REFERENCES COLLEGE_DETAILS(COLLEGE_ID) ON DELETE CASCADE,  
