...
public class ErrorDialog extends JDialog {
    ...
    private static Dimension MESSAGE_SIZE    = new Dimension(500,175);
    private static Dimension STACKTRACE_SIZE = new Dimension(500,200);
    private static Dimension TOTAL_SIZE      = new Dimension(500,400);
