...
/*	
	...
	from 
	EVENT_DETAILS, STUDENTS_DETAILS 
	where 
	EVENT_DETAILS.COLLEGE_ID = 'IT00' and 
	EVENT_DETAILS.EVENT_ID = 'quiz' and 
	EVENT_DETAILS.GROUP_ID = 
	(select EVENT_DETAILS.GROUP_ID from EVENT_DETAILS 
	where EVENT_DETAILS.STUDENT_ID ='IT001' 
	and EVENT_DETAILS.EVENT_ID = 'quiz') and
