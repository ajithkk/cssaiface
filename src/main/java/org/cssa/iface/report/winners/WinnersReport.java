 ...
 * 
 */
package org.cssa.iface.report.winners;
 ...
 *
 */
public class WinnersReport implements ReportService {
	 ...
	 */
	public WinnersReport(String fileName,
	...
	public void addTitle() {
		...
		header.setAlignment(Element.ALIGN_CENTER);
		addEmptyLine(header, 1);
		header.add(new Paragraph("Winners Details", new Font(FontFamily.HELVETICA, Font.DEFAULTSIZE, Font.BOLD)));
		addEmptyLine(header, 1);
		try {
			document.add(header);
